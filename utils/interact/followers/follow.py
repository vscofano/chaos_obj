...
class User:
    ...
    def follow(self,driver):
        ...
        self.name = TestDriver().find_element(*list_adress[0],driver).text
        print(self.name)
        btn_follow = TestDriver().find_element(*list_adress[1],driver)
    ...
    def unfollow(self,driver):
        ...
        self.name = TestDriver().find_element(*list_adress[0],driver).text#nao esta retornando o name como a funcao follow
        print(self.name)
        box_unfollow = TestDriver().find_element(*list_adress[0],driver)
        box_unfollow.click()
        time.sleep(2)
        driver.implicitly_wait(10)
        btn_unfollow = TestDriver().find_element(*list_adress[1],driver)
        btn_unfollow.click()
        print(f'\n Unfollow {self.name}')
        time.sleep(2)
